...
def dump_classifier_and_data(clf, dataset, features_list):
...
def load_classifier_and_data():
    ...
    with open(FEATURE_LIST_FILENAME, "r") as featurelist_infile:
        features_list = pickle.load(featurelist_infile)
    return clf, dataset, features_list

def main():
    ### load up student's classifier, dataset, and features_list
